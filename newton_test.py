...
def find_regrouping(model):
    ...
    cont = sys.argv[1]
    model_data = sio.loadmat("Data/model_2224_nbus"+str(cont)+"_ncont")
    y0_data = sio.loadmat("Data/y0_2224_nbus"+str(cont)+"_ncont")
    constr_data = sio.loadmat("Data/constr_2224_nbus"+str(cont)+"_ncont")

    construct_NewtonBDMatrix(model_data,y0_data,constr_data)